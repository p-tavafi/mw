...
class CampaignStatsProcessorBehavior extends CBehavior 
{
    ...
    protected function _getListSubscribers()
    {
        ...
        if (!empty($this->getOwner()->list_id)) {
            $cacheKey = sha1(__FILE__ . __METHOD__ . get_class($this->getOwner()->list) . $this->getOwner()->list_id);
    ...
    protected function _getSegmentSubscribers()
    {
        ...
        if (!empty($this->getOwner()->segment_id)) {
            $cacheKey = sha1(__FILE__ . __METHOD__ . get_class($this->getOwner()->segment) . $this->getOwner()->segment_id);
    ...
    protected function _getSubscribersCount()
    {
        ...
        $cacheKey = sha1(__FILE__ . __METHOD__ . get_class($this->getOwner()) . $this->getOwner()->campaign_id);
    ...
    protected function _getProcessedCount()
    {
        ...
        $cacheKey = sha1(__FILE__ . __METHOD__ . get_class($cdlModel) . $this->getOwner()->campaign_id);
    ...
    protected function _getDeliverySuccessCount()
    {
        ...
        $cacheKey = sha1(__FILE__ . __METHOD__ . get_class($cdlModel) . $this->getOwner()->campaign_id . CampaignDeliveryLog::STATUS_SUCCESS);
    ...
    protected function _getDeliveryErrorCount()
    {
        ...
        $cacheKey = sha1(__FILE__ . __METHOD__ . get_class($cdlModel) . $this->getOwner()->campaign_id . CampaignDeliveryLog::STATUS_ERROR);
    ...
    protected function _getOpensCount()
    {
        ...
        $cacheKey = sha1(__FILE__ . __METHOD__ . get_class($this->getOwner()) . $this->getOwner()->campaign_id . 'opens');
    ...
    protected function _getUniqueOpensCount()
    {
        ...
        $cacheKey = sha1(__FILE__ . __METHOD__ . get_class($this->getOwner()) . $this->getOwner()->campaign_id . 'opens-unique');
    ...
    protected function _getBouncesCount()
    {
        ...
        $cacheKey = sha1(__FILE__ . __METHOD__ . get_class($this->getOwner()) . $this->getOwner()->campaign_id . 'bounces');
    ...
    protected function _getHardBouncesCount()
    {
        ...
        $cacheKey = sha1(__FILE__ . __METHOD__ . get_class($this->getOwner()) . $this->getOwner()->campaign_id . 'bounces-hard');
    ...
    protected function _getSoftBouncesCount()
    {
        ...
        $cacheKey = sha1(__FILE__ . __METHOD__ . get_class($this->getOwner()) . $this->getOwner()->campaign_id . 'bounces-soft');
    ...
    protected function _getInternalBouncesCount()
    {
        ...
        $cacheKey = sha1(__FILE__ . __METHOD__ . get_class($this->getOwner()) . $this->getOwner()->campaign_id . 'bounces-internal');
    ...
    protected function _getIndustryOpensRate()
    {
        ...
        $cacheKey = sha1(__FILE__ . __METHOD__ . $this->getIndustry()->type_id);
