        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ...
                    ->add($this->widget('common.components.web.widgets.GridViewToggleColumns', array('model' => $deliveryLogs, 'columns' => array('subscriber.email', 'status', 'delivery_confirmed', 'date_added')), true))
                    ->addIf(CHtml::link(IconHelper::make('glyphicon-export') . Yii::t('campaign_reports', 'Export reports'), array($this->campaignReportsExportController . '/delivery', 'campaign_uid' => $campaign->campaign_uid), array('target' => '_blank', 'class' => 'btn btn-primary btn-flat', 'title' => Yii::t('campaign_reports', 'Export reports'))), !empty($canExportStats))
