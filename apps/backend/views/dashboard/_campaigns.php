            ...
            <div class="col-lg-6 col-md-6 col-sm-16 col-xs-12">
                <div class="box-dashboard">
                    <div class="progress-box">
                        ...
                        <div class="bar"><div class="progress" style="width: <?php echo $campaign->stats->getClicksRate(true);?>%"></div></div>
                    </div>
                    <ul class="custom-list">
                        ...
                        <?php if ($campaign->stats->getIndustryClicksRate()) { ?>
                            <li><span class="cl-span"><?php echo Yii::t('campaign_reports', 'Industry avg({industry})', array('{industry}' => CHtml::link($campaign->stats->getIndustry()->name, 'javascript:;')));?></span> <span class="cl-span"><?php echo $campaign->stats->getIndustryClicksRate(true);?>%</span></li>
                        <?php } ?>
                    </ul>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-16 col-xs-12">
                <div class="box-dashboard">
                    <div class="progress-box">
                        ...
                        <div class="bar"><div class="progress" style="width: <?php echo $campaign->stats->getOpensRate(true);?>%"></div></div>
                    </div>
                    <ul class="custom-list">
                        ...
                        <?php if ($campaign->stats->getIndustryOpensRate()) { ?>
                            <li><span class="cl-span"><?php echo Yii::t('campaign_reports', 'Industry avg({industry})', array('{industry}' => CHtml::link($campaign->stats->getIndustry()->name, 'javascript:;')));?></span> <span class="cl-span"><?php echo $campaign->stats->getIndustryOpensRate(true);?>%</span></li>
                        <?php } ?>
                    </ul>
                </div>
            </div>
