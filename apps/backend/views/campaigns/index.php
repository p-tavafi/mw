        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ->addIf($this->widget('common.components.web.widgets.GridViewToggleColumns', array('model' => $campaign, 'columns' => array('campaign_id', 'campaign_uid', 'customer_id', 'name', 'type', 'group_id', 'list_id', 'segment_id', 'search_recurring', 'status', 'send_at', 'gridViewOpens', 'gridViewClicks', 'gridViewBounces', 'gridViewUnsubs')), true), $itemsCount)
                ...
                $this->widget('zii.widgets.grid.CGridView', $hooks->applyFilters('grid_view_properties', array(
                    ...
                    'columns' => $hooks->applyFilters('grid_view_columns', array(
                        ...
                        array(
                            ...
                            'template'          => '{overview} {pause} {unpause} {reset} {marksent} {block} {unblock} {webversion} {delete}'
                        ),
                    ), $this),
                ), $this));
            }
