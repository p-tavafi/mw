        ...
        <div class="box-header">
            ...
            <div class="pull-right">
                <?php BoxHeaderContent::make(BoxHeaderContent::RIGHT)
                    ->add($this->widget('common.components.web.widgets.GridViewToggleColumns', array('model' => $log, 'columns' => array('customer_id', 'campaign_id', 'list_id', 'segment_id', 'subscriber_id', 'message', 'delivery_confirmed', 'status', 'server_id', 'date_added')), true))
