...
class OptionImporter extends OptionBase
{
    ...
    {
        $rules = array(
            array('enabled, file_size_limit, import_at_once, pause, check_mime_type, web_enabled, cli_enabled, url_enabled', 'required'),
            array('enabled, web_enabled, cli_enabled, url_enabled', 'in', 'range' => array_keys($this->getYesNoOptions())),
