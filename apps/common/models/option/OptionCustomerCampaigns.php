...
class OptionCustomerCampaigns extends OptionBase
{
    ...
    {
        $rules = array(
            array('max_campaigns, send_to_multiple_lists, must_verify_sending_domain, can_delete_own_campaigns, max_bounce_rate, can_export_stats, can_use_autoresponders, can_embed_images', 'required'),
            array('max_campaigns', 'numerical', 'integerOnly' => true, 'min' => -1),
            array('max_bounce_rate', 'numerical', 'integerOnly' => true, 'min' => -1, 'max' => 100),
            array('send_to_multiple_lists, must_verify_sending_domain, can_delete_own_campaigns, can_export_stats, can_use_autoresponders, can_embed_images', 'in', 'range' => array_keys($this->getYesNoOptions())),
